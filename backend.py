...
def execute_backtest(
    ...
    nav_series, applied_rebalance_dates = compute_nav_series(close_df, aligned_plans, primary_rebalance_dates)
    ...
    for mode in build_comparison_rebalance_modes(request.rebalance_mode):
        ...
        comparison_nav_series, comparison_applied_rebalances = compute_nav_series(
            close_df,
            aligned_plans,
        ...
        comparison_metrics.append(
            {
                ...
                "rebalance_count": len(comparison_applied_rebalances),
            }
        )
